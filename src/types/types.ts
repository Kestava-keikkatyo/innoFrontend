...
export enum notificationType {
  NOTIFICATION_POSTED_REQUEST = 'NOTIFICATION_POSTED_REQUEST',
  NOTIFICATION_POSTED_SUCCESS = 'NOTIFICATION_POSTED_SUCCESS',
  ...
  NOTIFICATION_GET_CURRENT_REQUEST = 'NOTIFICATION_GET_CURRENT_REQUEST',
  NOTIFICATION_GET_CURRENT_SUCCESS = 'NOTIFICATION_GET_CURRENT_SUCCESS',
  NOTIFICATION_UPDATED_REQUEST = 'NOTIFICATION_UPDATED_REQUEST',
  NOTIFICATION_UPDATED_SUCCESS = 'NOTIFICATION_UPDATED_SUCCESS',

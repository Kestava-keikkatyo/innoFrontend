...
export enum usersType {
  ...
  USER_ASSIGN_TO_BUSINESS_REQUEST = 'USER_ASSIGN_TO_BUSINESS_REQUEST',
  USER_ASSIGN_TO_BUSINESS_SUCCESS = 'USER_ASSIGN_TO_BUSINESS_SUCCESS',
  USER_ASSIGN_TO_BUSINESS_FAILURE = 'USER_ASSIGN_TO_BUSINESS_FAILURE',
}

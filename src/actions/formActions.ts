...
export const addQuestion =
  (question: FormQuestion) => async (dispatch: any) => {
...
export const setQuestions =
  (questions: Array<FormQuestion>) => async (dispatch: any) => {
...
export const updateQuestion =
  (question: FormQuestion, index: number) => async (dispatch: any) => {
...
export const updateQuestionOption =
  (option: string, questionIndex: number, optionIndex: number) =>
  async (dispatch: any) => {
    dispatch({
...
export const removeOptionValue =
  (questionIndex: number, optionValueIndex: number) =>
  async (dispatch: any) => {
    dispatch({
...
export const setDescription =
  (description: string) => async (dispatch: any) => {
...
export const updateForm =
  (formId: any, form: Form) => async (dispatch: any) => {
    if (form.title === "") {
      dispatch(setAlert("Title is required", severity.Error));
      return;
    }

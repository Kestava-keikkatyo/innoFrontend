export default {
  ...
  report_sort_date_created_new_to_old_reverse:
    "Raportointipäivän mukaan, käänteinen",
  report_sort_date_happened_new_to_old: "Tapahtumapäivän mukaan",
  report_sort_date_happened_new_to_old_reverse:
    "Tapahtumapäivän mukaan, käänteinen",
  ...
  report_reply_you_have_new_reply_in_report:
    "Sinulle on uusi vastaus raportissa:",

export default {
  ...
  forgot_password_text:
    'Unohtuiko salasana? Syötä alle sähköpostisi mihin saat ohjeet salasanan palauttamista varten.',
  ...
  neutral: 'Neutraali',
  good: 'Tyytyväinen',
  excellent: 'Erittäin tyytyväinen',
  ...
  fill_report_details:
    'Mitä tapahtui? Oliko henkilöitä vaarassa? Esim. Liukastuin jäisellä parkkipaikalla',
  ...
  report_sort_title_reverse: 'Otsikon mukaan, käänteinen',
  ...
  sent_contracts: 'Lähetetyt sopimukset',
  ...
  it: 'IT- ja tietoliikenne',
  education: 'Koulutus- ja opetusala',
  ...
  no_entries: 'Jos näet tämän, et ole vielä todennäköisesti kirjoittanut fiiliksiäsi',
  oops: 'oops',
  ...
  left_box_content:
    'Keikkakaverissa on omat sivut käyttäjäyritykselle, henkilöstöpalveluyritykselle ja vuokratyöntekijälle.',
  enable_button: 'OTA KÄYTTÖÖN',
  databank_button: 'SIIRRY TIETOPANKKIIN',
  right_box_header: 'Tietopankki',
  right_box_content:
    'Sivustolle on koottu tietoa työturvallisuuden, työterveyden ja työhyvinvoinnin edistämisestä vuokratyössä.',
  ...
  job_updated_successfully: 'Työn päivitys onnistui!',
  ...
  name_should_be_three_letters_at_least: 'Nimessä tulee olla vähintään kolme kirjainta!',
  ...
  send_feedback:
    'Anna palautetta nopeasti työvuorostasi sekä työkohteestasi. Voit halutessasi kirjoittaa lisätietoa tekstibokseihin.',
  thanks_for_feedback:
    'Kiitos palautteesta! Sen avulla voimme kehittää keikkatyötä sekä keikkatyöntekijöiden hyvinvointia.',
  feedback_title: 'Otsikko',
  feedback_message: 'Lähetetty lomake',
  feedback_receivedMessage: 'Vastaanotettu lomake',
  feedback_recipient: 'Vastaanottaja',
  feedback_sender: 'Lähettäjä',
  feedback_send_anonymously: 'Lähetä anonyymisti',
  ...
  feedback_shift: 'Mikä fiilis työvuoron jälkeen?',
  feedback_orientation: 'Miten perehdytys onnistui?',
  feedback_reception: 'Miten sinut otettiin työkohteessa vastaan?',
  feedback_appreciation: 'Arvostettiinko sinun työpanostasi?',
  feedback_expectation: 'Tiesitkö mitä sinulta odotettiin työvuorossa?',
  feedback_message_placeholder: 'Kerro halutessasi lisää tässä!',
  feedback_additional_message: 'Jotain muuta mistä haluat antaa palautetta?',
  ...
  my_feeling_enthusiastic: 'Innostunut',
  my_feeling_frustrated: 'Turhautunut',
  my_feeling_stressed: 'Stressaantunut',
  my_feeling_anxious: 'Ahdistunut',
  my_feeling_comment: 'Kommentti',
  my_feeling_do_you_feel_comfortable: 'Tuntuuko se mukavalta?',
  my_feeling_do_you_feel_satisfied: 'Oletko tyytyväinen?',
  my_feeling_do_you_feel_energetic: 'Tunnetko itsesi energiseksi?',
  my_feeling_do_you_feel_enthusiastic: 'Oletko innostunut?',
  my_feeling_do_you_feel_frustrated: 'Oletko turhautunut?',
  my_feeling_do_you_feel_stressed: 'Oletko stressaantunut?',
  ...
  RentalWorkModelOverview: [
    {
      header: ' Yleiskatsaus ',
      info:
        'Vuokratyössä on kolme osapuolta: henkilöstöpalveluyritys, käyttäjäyritys ja vuokratyöntekijä. Henkilöstöpalveluyritys ja käyttäjäyritys tekevät asiakassopimuksen. Henkilöstöpalveluyritys toimittaa' +
    ...
    },
    {
      ...
      info:
        'Henkilöstöpalveluyritys ja käyttäjäyritys tekevät asiakassopimuksen. Käyttäjäyritys antaa henkilöstöpalveluyritykselle tietoa työolosuhteista ja niihin liittyvistä työturvallisuus-, työterveys- ' +
    ...
    },
    {
      ...
      info:
        'Henkilöstöpalveluyritys ja vuokratyöntekijä tekevät kirjallisen työsopimuksen. Henkilöstöpalveluyritys antaa vuokratyöntekijälle yleisperehdytyksen, jossa käydään läpi mm. työntekijän velvoitteet, ' +
    ...
    },
    {
      ...
      info:
        'Käyttäjäyritys opastaa vuokratyöntekijän työhön ja työoloihin. Työnopastuksessa käydään läpi mm. työtehtävät ja turvalliset työtavat, työssä esiintyvät haitta- ja vaaratekijät ja niiltä suojautuminen,' +
  ...
  form1Text2:
    'TYÖNTEKIJÖILTÄ TYÖSSÄ EDELLYTETTÄVÄ KOULUTUS JA TYÖKOKEMUS SEKÄ TYÖN AMMATTITAITOVAATIMUKSET',
  form1Text3:
  ...
  form1Text11:
    'KUVAUS VUOKRAYRITYKSEN JA KÄYTTÄJÄYRITYKSEN VÄLISESTÄ YHTEYDENPIDOSTA ASIAKKUUDEN AIKANA',
  ...
  form2Text4:
    'Seuraavat asiat on käyty läpi yleisperehdytyksen yhteydessä kaikille vuokratyöntekijöille',
  form2Text5:
  ...
  form3Text4:
    'Seuraavat asiat on käyty läpi käyttäjäyrityksen työntekijälle antamassa työnopastuksessa',
  ...
  // Form 4
  form4Header:
    'LOMAKE 4 – TOIMINNAN ARVIOINTI (käyttäjäyrityksen ja vuokrayrityksen edustajat täyttävät)',
  form4Text1:
  ...
  form4Text4:
    'YHTEENVETO TOIMEKSIANNON (TYÖTURVALLISUUTEEN LIITTYVISTÄ) ONNISTUMISISTA JA HYVIN SUJUNEISTA ASIOISTA',
  form4Text5:
    'YHTEENVETO TOIMEKSIANNON AIKANA ILMENNEISTÄ ONGELMISTA/PARANTAMISTA VAATIVISTA ASIOISTA',
  form4Text6:
    'MITEN OMAA TOIMINTAA VOIDAAN KEHITTÄÄ, JOTTA EDELLÄ MAINITTUJA ASIOITA SAADAAN JATKOSSA PARANNETTUA',
  form4Check1:
  ...
  businessResponsibilitiesArray: [
    ...
    },
    {
      ...
      summary:
        'Henkilöstöpalveluyritys ja käyttäjäyritys sopivat työvaatetuksen tarjoamisesta työntekijälle,' +
  ...
  agencyResponsibilitiesArray: [
    ...
    },
    {
      header: '6. Tasa-arvon ja yhdenvertaisuuden edistäminen',
      summary:
        'Henkilöstöpalveluyrityksen on arvioitava yhdenvertaisuuden toteutumista työpaikalla.',
    },
    {
      header: '7. Käyttäjäyrityksen velvoitteiden täyttämisen varmistaminen',
      summary:
        ' Vuokratyössä henkilöstöpalveluyrityksellä ja käyttäjäyrityksellä on jaettu työsuojeluvastuu.' +
  ...
  privacy_policies1:
    'Rekisteröitymällä hyväksyt antamasi tietojen lähetyksen Keikkakaverille ja henkilöstöpalveluyrityksille, sekä sinua koskeville käyttäjäyrityksille.',
  privacy_policies2:
    'Tietoja kerätään, jotta henkilöstöpalveluyritykset voivat välittää työntekijälle työtä ja siihen liittyviä tietoja ja lähettää työntekijän tietoja työn tilanneelle käyttäjäyritykselle.',
  privacy_policies3:
    'Rekisteröityminen on välttämätöntä, sillä työnvälitys ei onnistu ilman henkilötietoja.',
  privacy_policies4:
    'Tietoja säilytetään kannassa toistaiseksi. Halutessaan käyttäjällä on oikeus poistattaa tietonsa ottamalla yhteyttä Keikkakaverin ylläpitoon.',
  privacy_policies5:
    'Henkilötietojasi välitetään käyttäjäyrityksille ainoastaan silloin, kun olet menossa yritykselle töihin.',
  privacy_policies6:
    'Keikkakaverin keräämiin henkilötietohin kuuluvat nimi, sähköpostiosoite, osoitetiedot ja puhelinnumero.',
  privacy_policies7:
    'Rekisteröitymisen yhteydessä kerätään ainoastaan nimi ja sähköpostiosoite. Muut tiedot voi lisätä myöhemmin, eivätkä ne ole pakollisia.',
  ...
  keikkakaveri_summary:
    'Keikkakaveri on kehitetty Kestävä keikkatyö-hankkeessa. Hankkeen toteuttivat ' +
  ...
  stages_of_work_summary:
    'Vuokratyössä on kolme osapuolta: henkilöstöpalveluyritys, käyttäjäyritys ja vuokratyöntekijä. Alla on kuvattu yhteistyön viisi vaihetta.',
  responsibilities_summary:
    'Jokaisella vuokratyön osapuolella on työturvallisuuteen, työterveyteen ja työhyvinvointiin liittyviä vastuita.',
  instructions_summary:
    'Ohjeet ovat lyhyitä tekstejä siitä, miten henkilöstöpalveluyritys, käyttäjäyritys ja vuokratyöntekijä voivat huolehtia vuokratyöntekijän työturvallisuudesta, työterveydestä ja työhyvinvoinnista. Ohjeessa on kerrottu aiheeseen liittyvät lait, mahdolliset muut internetlinkit ja lomakkeet.',
  good_practises_summary:
    'Alla on esimerkkejä vuokratyön eri vaiheisiin liittyvistä hyvistä käytännöistä.',
  forms_summary:
    'Lomakepohjat ohjaavat huolehtimaan tärkeistä asioista vuokratyötoimeksiannon eri vaiheissa. Lomakkeiden täyttäminen varmistaa, että olennaisimmat vuokratyöntekijän työturvallisuuteen liittyvät seikat käydään läpi ja tärkeistä asioista sovitaan pelisäännöt henkilöstöpalvelu- ja käyttäjäyrityksen välillä. Kahden osapuolen kesken täytetty lomake voidaan aina antaa tiedoksi myös kolmannelle osapuolelle. Tämä toimii osana kumppaneiden välistä tiedonkulkua ja tärkeän informaation perillemenon varmistamista.',

...
const DatabankRoute: React.FC<DatabankProps> = ({ path, children }) => {
  ...
  const [colors, setColors] = useState({
    stages_of_work: 'databank-nav-link',
    work_responsibilities: 'databank-nav-link',
    instructions: 'databank-nav-link',
    good_practises: 'databank-nav-link',
    forms: 'databank-nav-link',
  })
  ...
  const handleSwitch = (page: string) => {
    switch (page) {
      case 'stages_of_work':
        setColors({
          ...colors,
          stages_of_work: 'databank-nav-link-active',
          work_responsibilities: 'databank-nav-link',
          instructions: 'databank-nav-link',
          good_practises: 'databank-nav-link',
          forms: 'databank-nav-link',
      ...
      case 'work_responsibilities':
        setColors({
          ...colors,
          stages_of_work: 'databank-nav-link',
          work_responsibilities: 'databank-nav-link-active',
          instructions: 'databank-nav-link',
          good_practises: 'databank-nav-link',
          forms: 'databank-nav-link',
        })
      ...
      case 'instructions':
        setColors({
          ...
          stages_of_work: 'databank-nav-link',
          work_responsibilities: 'databank-nav-link',
          instructions: 'databank-nav-link-active',
          good_practises: 'databank-nav-link',
          forms: 'databank-nav-link',
        })
      ...
      case 'good_practises':
        setColors({
          ...
          work_responsibilities: 'databank-nav-link',
          instructions: 'databank-nav-link',
          good_practises: 'databank-nav-link-active',
          forms: 'databank-nav-link',
        })
      ...
      case 'forms':
        setColors({
          ...
          instructions: 'databank-nav-link',
          good_practises: 'databank-nav-link',
          forms: 'databank-nav-link-active',
        })
        setRouteText('forms')
        break
    }
      ...
      <div>
        <AppBar position='fixed' elevation={1} style={{ boxShadow: 'none', height: '60p' }}>
          <Toolbar className='toolbar' style={{ backgroundColor: '#F47D20' }}>
            ...
            <Typography className='test' sx={{ display: { xs: 'none', sm: 'none', md: 'flex' } }}>
            ...
            >
              ...
              <Link to='/login' style={{ textDecoration: 'none' }}>
                <Button className='databank-button'>{t('login_title')}</Button>
              </Link>
        ...
        >
          ...
          <Grid
            ...
            spacing={4}
            sx={{
              flexWrap: { xs: 'wrap-reverse', sm: 'wrap-reverse' },
              backgroundColor: '#F47D20',
              width: '60%',
              justifyContent: 'center',
              margin: 'auto',
          ...
          >
            ...
            >
              <Grid
                ...
                style={{ textAlign: 'center', height: '100%', justifyContent: 'end', width: '90%' }}
              >
        ...
        >
          ...
          >
            <Button style={{ padding: 5, width: '100%', whiteSpace: 'nowrap' }}>
              <Link
                ...
                onClick={() => handleSwitch('stages_of_work')}
                className={colors.stages_of_work}
          ...
          >
            <Button style={{ padding: 5, width: '100%', whiteSpace: 'nowrap' }}>
              <Link
                style={{ minHeight: '40px', fontSize: '14px' }}
                onClick={() => handleSwitch('work_responsibilities')}
                className={colors.work_responsibilities}
          ...
          >
            <Button style={{ padding: 5, width: '100%', height: '100%', whiteSpace: 'nowrap' }}>
              <Link
                style={{ minHeight: '40px', fontSize: '14px' }}
                onClick={() => handleSwitch('instructions')}
                className={colors.instructions}
                to='/databank/instructions'
              >
                {t('instructions')}
              </Link>{' '}
              {/*Ohjeet */}
          ...
          >
            <Button style={{ padding: 5, width: '100%', whiteSpace: 'nowrap' }}>
              <Link
                style={{ minHeight: '40px', fontSize: '14px' }}
                onClick={() => handleSwitch('good_practises')}
                className={colors.good_practises}
                to='/databank/best-practices'
              >
                {t('good_practises')}
              </Link>{' '}
              {/*Hyvät käytännöt */}
          ...
          >
            <Button style={{ padding: 5, width: '100%', whiteSpace: 'nowrap' }}>
              <Link
                style={{ minHeight: '40px', fontSize: '14px' }}
                onClick={() => handleSwitch('forms')}
                className={colors.forms}
                to='/databank/faq'
              >
                {t('rwm_forms')}
              </Link>{' '}
          ...
          >
            ...
            <InputBase
              style={{ border: '2px solid grey', borderRadius: '5rem' }}
        ...
        <Grid
          ...
          style={{ display: 'flex', flexDirection: 'row', margin: 'auto', marginTop: '32px' }}
        >
          <Link
            to='/home'

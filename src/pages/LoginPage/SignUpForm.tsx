            ...
            {({ isValid, dirty, values, setFieldValue }) => (
              <Form>
                <Box display='flex' flexDirection='column'>
                  <FormikTextField label={t('firstName')} name='firstName' type='text' />
                  <FormikTextField label={t('lastName')} name='lastName' type='text' />
                  <FormikTextField
                    label={t('email')}
                    name='email'
                    type='text'
                  ...
                  <Box display='flex' flexDirection='column' className='marginTop2'>
                    <FormikSelectField label={t('role')} name='role' options={roleOptions} />
                  </Box>
                  {(values.role === roles.Agency || values.role === roles.Business) && (
                    <>
                      <Box display='flex' flexDirection='column' className='marginTop2'>
                        <FormikTextField label={t('companyName')} name='companyName' type='text' />
                      </Box>

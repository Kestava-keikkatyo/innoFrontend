                ...
                {currentForm.questions.map((q: any | null, k:number) => (
                    ...
                    <div  key={k}>
                        ...
                        {(q && q.questionType === 'text') ? (
                            <div>
                                <p style={styles.title}>{q.title} {q.answer}</p>
                                ...
                                <table key={q._id}>
                                    <tbody>
                                        {q.answer ? (
                                            ...
                                            <tr key={q._id}>
                                                <td style={{marginRight: 190, marginLeft:'-5',border:'none', fontSize:12 }}>Name.</td>

                                                <td style={{marginRight: 190,border:'none', fontSize:12 }}>Phone.</td>

                                                <td style={{border:'none', fontSize:12 }}>Email.</td>
                                            </tr>

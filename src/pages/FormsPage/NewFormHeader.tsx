    ...
    <Grid container direction='row' alignItems='self-end'>
      ...
      <Grid item xs={12} sm={8} md={6}>
        <Grid container style={{ justifyContent: 'end' }}>
          ...
          <Button className='form-button' color='primary' variant='outlined' onClick={handleSubmit}>
            {' '}
            {t('submit')}
          </Button>
          <Button className='form-button' color='primary' variant='outlined'>
            <Link className='button-text' to='/forms/newform/preview'>
              {' '}
              {t('preview')}
            </Link>
          </Button>
          <Button className='form-button' color='primary' variant='outlined'>
            <Link className='button-text' to='/forms'>
              {' '}
              {t('back')}
            </Link>
          </Button>

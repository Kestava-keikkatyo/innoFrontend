      ...
      case displayState.All:
        return (
          ...
          [].concat(
            reports
              .sort(compareFn)
              .map((report: any) => <Report key={report._id} report={report} />),
          )
        )
        ...
        <Grid item style={{ display: 'flex', flexWrap: 'wrap' }}>
          ...
          <Box sx={{ minWidth: '50px', margin: '10px 10px 0px 0px' }}>
            <FormControl fullWidth>
              ...
              >
                ...
                <MenuItem value={displayState.NotArchived}>
                  {t('report_display_not_archived')}
                </MenuItem>
              </Select>
            </FormControl>
          </Box>
          ...
          <Box sx={{ minWidth: '200px', margin: '10px 0px 10px 0px' }}>
            <FormControl fullWidth>
              ...
              >
                <MenuItem value={sortingState.DateCreatedNewToOld}>
                  {t('report_sort_date_created_new_to_old')}
                </MenuItem>
                <MenuItem value={sortingState.DateCreatedOldToNew}>
                  {t('report_sort_date_created_new_to_old_reverse')}
                </MenuItem>
                <MenuItem value={sortingState.DateHappenedNewToOld}>
                  {t('report_sort_date_happened_new_to_old')}
                </MenuItem>
                <MenuItem value={sortingState.DateHappenedOldToNew}>
                  {t('report_sort_date_happened_new_to_old_reverse')}
                </MenuItem>
                ...
                <MenuItem value={sortingState.RepliedReverse}>
                  {t('report_sort_replied_reverse')}
                </MenuItem>
              </Select>
            </FormControl>
          </Box>

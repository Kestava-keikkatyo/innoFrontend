      ...
      <Accordion>
        ...
        >
          ...
          <Box className='report1' sx={{ width: '35%' }}>
            ...
            {/**Archived-status*/}
            {report[archivedRole] === 'true' && (
              <Typography display='inline'>{` | ${t('report_is_archived')}`}</Typography>
            )}
          </Box>
        </AccordionSummary>
        ...
        <AccordionDetails className={classes.details}>
            ...
            <div style={{ marginTop: 16 }}>
              ...
              {report.agency && (
                ...
                <Box>
                  ...
                  <Typography display='inline' sx={{ color: 'secondary.main' }}>
                    {report.agency.name}
                  </Typography>
                </Box>
              )}
          ...
          {report.agencyReply && (
            ...
            >
              ...
              <Typography
                variant='body2'
                className={classes.body2}
                sx={{ whiteSpace: 'pre-wrap', marginBottom: '1em' }}
              >
                {report.agencyReply}
              </Typography>
            </Box>
          ...
          */}
          {((!report.agencyReply && role === roles.Agency) ||
            (!report.businessReply && role === roles.Business)) && (
            <Button
              variant='contained'

...
const WorkRequestUpdate: React.FC = () => {
  ...
  if (!workRequestData || workRequestId !== workRequestData._id) return <PageLoading />
            ...
            return (
              <Form>
                ...
                <Stack direction='row' spacing={2}>
                  ...
                  <Button variant='outlined' color='primary' component={Link} to='/workRequests'>
                    {t('button_cancel')}
                  </Button>
                </Stack>
              </Form>

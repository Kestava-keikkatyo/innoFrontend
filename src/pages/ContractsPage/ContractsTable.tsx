...
import { TableContainer, Table, IconButton, TableBody, TableCell, TableHead, TableRow, Typography, Grid, Card, CardContent, Divider, makeStyles } from '@material-ui/core'
import { Delete as DeleteIcon } from '@material-ui/icons'
import DoneIcon from '@material-ui/icons/Done';
import ClearIcon from '@material-ui/icons/Clear';
import { useDispatch, useSelector } from 'react-redux'
import { deleteBusinessContractById, fetchBusinessContracts, addBusinessContract, declineBusinessContract } from '../../actions/businessContractActions'
      ...
      <Grid item xs={12} md={6}>
        <Card className={classes.card} variant="outlined">
          <CardContent>
            ...
            <Divider />
            <MCTable contracts={contracts[0].madeContracts.businesses} deleteContract={deleteContract}/>
          </CardContent>
          <CardContent>
            <Typography gutterBottom variant="h6"> 
              Workers
            ...
            <Divider />
            <MCTable contracts={contracts[0].madeContracts.workers} deleteContract={deleteContract}/>
          </CardContent>
        </Card>
      </Grid>
      <Grid item xs={12} md={6}>
        <Card className={classes.card} variant="outlined">
          <CardContent>
            ...
            <Divider />
            <RCTable contracts={contracts[0].requestContracts.businesses} contractId={businessContract[0]._id} acceptContract={acceptContract} declineContract={declineContract}/>
          </CardContent>
          <CardContent>
            <Typography gutterBottom variant="h6"> 
              Workers
            ...
            <Divider />
            <RCTable contracts={contracts[0].requestContracts.workers} contractId={businessContract[0]._id} acceptContract={acceptContract} declineContract={declineContract}/>
          </CardContent>
        </Card>
      </Grid>
    </Grid>
...
const RCTable = (prop: {contracts: [],contractId:string, acceptContract:Function, declineContract:Function }) => {

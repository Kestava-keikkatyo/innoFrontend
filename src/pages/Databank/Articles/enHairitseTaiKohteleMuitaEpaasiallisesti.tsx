...
const Article15 = () => {
    ...
    return (
        <Grid container>
            <Grid item className={classes.gridItem}>Työntekijän on työpaikalla vältettävä sellaista muihin työntekijöihin kohdistuvaa häirintää ja muuta epäasiallista kohtelua, joka aiheuttaa heidän turvallisuudelleen tai terveydelleen haittaa tai vaaraa. Työntekijän tulee ilmoittaa kokemastaan häirinnästä työnantajalle. </Grid>
            ...
            <Grid item style={{ display: 'inline-block', width: '100%' }}>Epäasiallinen kohtelu.</Grid>
            <Link href="https://www.tyosuojelu.fi/tyoolot/epaasiallinen-kohtelu" className={classes.gridItem}>https://www.tyosuojelu.fi/tyoolot/epaasiallinen-kohtelu </Link>
        </Grid>
    )
}

  ...
  return (
    <Grid container>
      <Grid item className={classes.gridItem}>
        Henkilöstöpalveluyrityksen työnantajana pitää vakuuttaa vuokratyöntekijät työtapaturman ja
        ammattitaudin varalta. Vakuutus koskee kaikkia henkilöstöpalveluyrityksen työntekijöitä,
        jollei yrityksen määrättyä osaa tai määrättyä työtä varten ole otettu eri vakuutusta.{' '}
      </Grid>

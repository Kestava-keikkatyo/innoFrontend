            ...
            <Grid sx={{ width: { xs: '90%', md: '60%' } }} style={{ backgroundColor: "#DBE4FC", margin: "auto", alignItems: "center", paddingTop: '30px' }}>
                ...
                >
                    <AccordionSummary
                        ...
                        aria-controls="panel1a-content"
                        id="panel1a-header">
                        <Typography style={{ fontWeight: 'bold', backgroundColor: "#FDFDFD" }}>{t('header10')}</Typography>
                    </AccordionSummary>
                    <AccordionDetails style={{ display: 'block', backgroundColor: "#FDFDFD", wordWrap: 'break-word', borderRadius: '25px' }}>
                ...
                >
                    <AccordionSummary
                        ...
                        aria-controls="panel1a-content"
                        id="panel1a-header">
                        <Typography style={{ fontWeight: 'bold', backgroundColor: "#FDFDFD" }}>{t('header13')}</Typography>
                    </AccordionSummary>
                    <AccordionDetails style={{ display: 'block', backgroundColor: "#FDFDFD", wordWrap: 'break-word', borderRadius: '25px' }}>

  ...
  return (
    <Grid container>
      <Grid item className={classes.gridItem}>
        Käyttäjäyrityksen on määriteltävä vuokratyön edellyttämät ammattitaitovaatimukset ja työn
        erityispiirteet ja ilmoitettava ne henkilöstöpalveluyritykselle ennen työn aloittamista.{' '}
      </Grid>
      <Grid item className={classes.gridItem}>
        Käyttäjäyrityksen on toimitettava henkilöstöpalveluyritykselle ne tiedot, jotka
        henkilöstöpalveluyritys työnantajana tarvitsee velvollisuuksiensa täyttämiseksi. Tällaisia
        tietoja ovat esimerkiksi tiedot työvuoroista ja toteutuneista työajoista.{' '}
      </Grid>
      ...
      <Grid item style={{ display: 'inline-block', width: '100%' }}>
        Työturvallisuuslaki 738/2002 3§.
      </Grid>
      <Link

...
const Article9 = () => {
    ...
    return (
        <Grid container>
            <Grid item className={classes.gridItem}>Vastuu vuokratyöntekijän tarvitsemista henkilösuojaimista ja niiden hankkimisesta on sekä henkilöstöpalveluyrityksellä että käyttäjäyrityksellä.  </Grid>
            <Grid item className={classes.gridItem}>Henkilönsuojaimen on suojattava vaaroilta, joita varten se on tarkoitettu, sovittava sitä käyttävälle työntekijälle, eikä suojaimen käyttö saa aiheuttaa vaaraa. Ensisijaisesti vaarat poistetaan työhön tai työolosuhteisiin kohdistuvilla toimenpiteillä. Jos vaaroja ei pystytä muuten poistamaan tai vähentämään tarpeeksi, käytetään henkilönsuojaimia. </Grid>
            <Grid item className={classes.gridItem}>Henkilöstöpalveluyrityksen ja käyttäjäyrityksen tulee keskenään sopia tarvittavien henkilösuojaimien hankkimisesta vuokratyöntekijöille. Myös henkilönsuojainten kunnossapidosta huolehtimisesta tulee sopia. Käyttäjäyrityksellä on yleinen vuokratyöntekijöiden valvontavastuu. Käyttäjäyrityksen tulee huolehtia siitä, että vuokratyöntekijä käyttää työssään tarvittavia henkilönsuojaimia ohjeiden mukaisesti. </Grid>

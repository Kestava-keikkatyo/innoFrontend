  ...
  return (
    <Grid container>
      <Grid item className={classes.gridItem}>
        Henkilöstöpalveluyrityksen tulee saada käyttäjäyritykseltä tieto työn edellyttämistä
        ammattitaitovaatimuksista ja työn erityispiirteistä ennen vuokratyön aloittamista.
        Henkilöstöpalveluyrityksen tulee ilmoittaa vuokratyöntekijälle edellä tarkoitetuista
        seikoista. Henkilöstöpalveluyrityksen on varmistettava, että vuokratyöntekijällä on riittävä
        ammattitaito, kokemus ja sopivuus suoritettavaan työhön.{' '}
      </Grid>
      <Grid item className={classes.gridItem}>
        Henkilöstöpalveluyrityksen työnantajana on arvioitava yhdenvertaisuuden toteutumista

  ...
  return (
    <Grid container>
      <Grid item className={classes.gridItem}>
        ...
        turvallisuudesta ja terveydestä työssä. Henkilöstöpalveluyrityksen on tarpeellista käydä
        käyttäjäyrityksen kanssa läpi lainsäädännöstä seuraavien vastuiden jakautuminen
        vuokratyössä. On mahdollista, että käyttäjäyritykset eivät välttämättä ole tietoisia
        vastuistaan ja velvoitteistaan, ainakaan mikäli ovat ensimmäistä kertaa vuokraamassa
        työvoimaa käyttöönsä. Vastuita ja velvoitteita tulee esimerkiksi
        työturvallisuuslainsäädännön velvoitteista liittyen perehdytykseen, riskienarviointiin ja
        -hallintaan, työsuojelun yhteistoimintaan ja valvontavastuisiin. Lisäksi tulee huolehtia,
        että käyttäjäyritys on tietoinen ja huolehtii esimerkiksi työaika- ja yhdenvertaisuuslain
        mukaisista velvoitteista.{' '}
      </Grid>
      <Grid item className={classes.gridItem}>
        Käyttäjäyrityksen vastuut vuokratyössä ovat:{' '}
      </Grid>
      ...
      <ul>
        <li>
          Työn aikaisesta työn turvallisuudesta ja terveellisyydestä huolehtiminen, ml. tarvittavien
          henkilönsuojainten ja turvavälineiden käyttämisen varmistaminen{' '}
        </li>
      ...
      <p className={classes.steps}>
        7. Tarvittavien henkilönsuojainten hankinta (yhteistyössä henkilöstöpalveluyrityksen
        kanssa)  
      </p>

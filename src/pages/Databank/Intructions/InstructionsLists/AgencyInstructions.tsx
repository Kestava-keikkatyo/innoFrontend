            ...
            <Grid sx={{ width: { xs: '90%', md: '60%' } }} style={{ backgroundColor: "#FFDCBF", margin: "auto", alignItems: "center", paddingTop: '30px' }}>
                ...
                >
                    <AccordionSummary
                        ...
                        aria-controls="panel1a-content"
                        id="panel1a-header">
                        <Typography style={{ fontWeight: 'bold', backgroundColor: "#FDFDFD" }}>{t('header19')}</Typography>
                    </AccordionSummary>
                    <AccordionDetails style={{ display: 'block', backgroundColor: "#FDFDFD", wordWrap: 'break-word', borderRadius: '25px' }}>
                ...
                >
                    <AccordionSummary
                        ...
                        aria-controls="panel1a-content"
                        id="panel1a-header">
                        <Typography style={{ fontWeight: 'bold', backgroundColor: "#FDFDFD" }}>{t('header20')}</Typography>
                    </AccordionSummary>
                    <AccordionDetails style={{ display: 'block', backgroundColor: "#FDFDFD", wordWrap: 'break-word', borderRadius: '25px' }}>
                ...
                >
                    <AccordionSummary
                        ...
                        aria-controls="panel1a-content"
                        id="panel1a-header">
                        <Typography style={{ fontWeight: 'bold', backgroundColor: "#FDFDFD" }}>{t('header21')}</Typography>
                    </AccordionSummary>
                    <AccordionDetails style={{ display: 'block', backgroundColor: "#FDFDFD", wordWrap: 'break-word', borderRadius: '25px' }}>

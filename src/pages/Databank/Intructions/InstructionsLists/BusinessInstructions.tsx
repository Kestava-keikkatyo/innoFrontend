            ...
            <Grid sx={{ width: { xs: '90%', md: '60%' } }} style={{ backgroundColor: "#FFDCBF", margin: "auto", alignItems: "center", paddingTop: '30px' }}>
                ...
                >
                    ...
                    <AccordionDetails style={{ display: 'block', backgroundColor: "#FDFDFD", wordWrap: 'break-word', borderRadius: '25px' }}>
                        ...
                        {isShown && (
                            <Jaettu_tyosuojeluvastuu></Jaettu_tyosuojeluvastuu>
                        )}
                    </AccordionDetails>
                </Accordion>
                ...
                >
                    <AccordionSummary
                        ...
                        aria-controls="panel1a-content"
                        id="panel1a-header">
                        <Typography style={{ fontWeight: 'bold', backgroundColor: "#FDFDFD" }}>{t('header11')}</Typography>
                    </AccordionSummary>
                    <AccordionDetails style={{ display: 'block', backgroundColor: "#FDFDFD", wordWrap: 'break-word', borderRadius: '25px' }}>
                        ...
                        {isShown && (
                            <TietojenAntaminenHp></TietojenAntaminenHp>
                        )}
                    </AccordionDetails>
                </Accordion>
                ...
                >
                    <AccordionSummary
                        ...
                        aria-controls="panel1a-content"
                        id="panel1a-header">
                        <Typography style={{ fontWeight: 'bold', backgroundColor: "#FDFDFD" }}>{t('header12')}</Typography>
                    </AccordionSummary>
                    <AccordionDetails style={{ display: 'block', backgroundColor: "#FDFDFD", wordWrap: 'break-word', borderRadius: '25px' }}>

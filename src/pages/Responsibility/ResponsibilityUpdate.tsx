...
const ResponsibilityUpdate: React.FC = () => {
    ...
    if (!responsibilityData || responsibilityId !== responsibilityData._id) return (
      <PageLoading />
    );
    ...
    return (
      <div className={classes.newResponsibility}>
        <div className={classes.responsibilityTitleContainer}>
          <Typography color="primary" className={classes.title} variant="h5">{t('responsibility_update_responsibility')}</Typography>
        </div>

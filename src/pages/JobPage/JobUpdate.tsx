  ...
  return (
    <div className={classes.newJob}>
      ...
      <div className={classes.jobContainer}>
        <Formik initialValues={jobData} onSubmit={handleSubmit} validationSchema={CreateJobSchema}>
          {(props) => {
            return (
              <Form>
                <div className={classes.jobContainerTop}>
                  ...
                  <DatePickerField
                    ...
                    label={t('job_applicationLastDate')}
                    {...props}
                  />
                ...
                <Stack direction='row' spacing={2}>
                  ...
                  <Button variant='outlined' color='primary' component={Link} to='/job?tab=my'>
                    {t('button_cancel')}
                  </Button>
                </Stack>
              </Form>

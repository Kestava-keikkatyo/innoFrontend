      ...
      <div className='icd'>
        <AppBar position='fixed' elevation={1} className='landing-appbar'>
          <Toolbar className='toolbar'>
                  ...
                  <Typography textAlign='center'>
                    {user ? (
                      ...
                      <Link className='landing-login-dropdown' to='/login'>
                        <Typography sx={{ fontWeight: 'bold' }}>{t('kirjaudu_sisaan')}</Typography>
                      </Link>
                    )}
                  </Typography>
                </MenuItem>
            ...
            <Typography sx={{ mr: 2, display: { xs: 'flex', sm: 'none' }, flexGrow: 1 }}>
              <Link to='/' style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Box sx={{ flexGrow: 0, display: { xs: 'none', sm: 'flex' } }}>
              <Link
                className='landing-nav-link2'
                to='/databank/lifeline'
                style={{ height: '40px' }}
              >
                <Typography sx={{ px: 2.5, fontWeight: 'bold' }}>{t('tietopankki')}</Typography>
              </Link>
              ...
              {user ? (
                <Link
                  ...
                  to='/home'
                  style={{ backgroundColor: '#FDFDFD', height: '40px' }}
                >

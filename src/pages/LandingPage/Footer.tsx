...
const Footer = () => {
    ...
    return (
        <ThemeProvider theme={fontTheme}>
            <Container style={{ backgroundColor: '#C0CFFA', maxWidth: 'none', paddingTop: '32px' }}>
                <Grid container spacing={4} style={{ paddingLeft: '20%', paddingRight: '20%' }}>
                    <Grid item xs={12} sm={12} md={4}>
                        <img src={footer_logo} alt='Keikkakaveri logo' style={{ maxWidth: '200px', marginBottom: '8px' }}></img>
                    ...
                    <Grid item xs={12} sm={12} md={4}>
                        <div style={{ display: 'flex', flexDirection: 'column' }}>
                            <div style={{ display: 'flex', alignItems: 'center' }}>
                                <img src={link_out} alt='Link out icon' style={{ width: 'auto', height: '24px', marginRight: '8px' }}></img>
                                <a href="https://www.metropolia.fi/fi/tutkimus-kehitys-ja-innovaatiot/hankkeet/kestava-keikkatyo-hanke" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
                                    <Typography>Kestävä keikkatyö</Typography>
                                </a>
                            </div>
                            <div style={{ display: 'flex', alignItems: 'center', marginTop: '8px' }}>
                                <img src={link_out} alt='Link out icon' style={{ width: 'auto', height: '24px', marginRight: '8px' }}></img>
                                <a href="https://ttk.fi/" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
            ...
            <Typography style={{ textAlign: 'center', fontSize: '12px', backgroundColor: '#C0CFFA', padding: '16px 0 16px 0' }}>
                © 2023 Keikkakaveri
            </Typography>
        </ThemeProvider >
    );

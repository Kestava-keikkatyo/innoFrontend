        ...
        <Grid item xs={12} md={4} style={{ marginBottom: '1rem' }}>
          <div className='responsibilty-card'>
            <div style={{ display: 'flex' }} onClick={handleWorkerExpand}>
              ...
              <ExpandMore expand={workerExpand} aria-expanded={workerExpand} aria-label='show more'>
                <ExpandMoreIcon />
              </ExpandMore>
            </div>
          ...
          <div className='responsibilty-card'>
            <div style={{ display: 'flex' }} onClick={handleAgencyExpand}>
              <CardHeader
                ...
                title={t('agency')}
              />
              <ExpandMore expand={agencyExpand} aria-expanded={agencyExpand} aria-label='show more'>
                <ExpandMoreIcon />
              </ExpandMore>
            </div>

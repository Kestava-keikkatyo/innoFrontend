...
const FooterPage: React.FC<FooterPageProps> = () => {
  ...
  const CustomCard: React.FC<any> = ({ header, content }) => (
    <Card variant='outlined'>
      <CardContent>
        <Typography variant='h1' className='card-header'>
          {header}
        </Typography>
        <Spacing m2 />
  ...
  return (
    <Grid container alignItems='stretch' justifyContent='flex-start' className='landing-part4'>
      <Container>
          ...
          <Grid container className='landing-container2'>
            <Grid item xs={12} md={4} className='landing-container'>
              <CustomCard
                ...
                content={[t('make_money'), t('work_flexibly'), t('stressFree_work')]}
              />
            </Grid>
            <Grid item xs={12} md={4} className='landing-container'>
              <CustomCard
                header={t('user_company')}
                content={[t('flexible_model'), t('recruitment_process'), t('productivity')]}
              />
            </Grid>
            <Grid item xs={12} md={4} className='landing-container'>
              <CustomCard
                header={t('rental_company')}
                content={[t('orientation'), t('automation'), t('wellBeing')]}
              />
            </Grid>
          </Grid>
        </Grid>

            ...
            <CardContent>
              ...
              >
                {() => {
                  return (
                    <Form>
                      <FormikField name="newPassword" label={t('new_password')} type="password" required />
                      <FormikField name="confirmNewPassword" label={t('confirm_password')} type="password" required />
                      <Stack direction="row" spacing={2}>
                        <Button type="submit" variant="contained" color="primary">{t('set_new_password_submit')}</Button>
                        <Button variant="outlined" color="primary" onClick={() => history.push('/')}>{t('button_cancel')}</Button>
                      </Stack>
                    </Form>
                  );
                }}

...
const FeedbackUpdate: React.FC = () => {
  ...
  const initialValues: Feedback = {
    ...
    recipientFirstName: feedbackData.recipientFirstName,
    recipientLastName: feedbackData.recipientLastName,
        ...
        >
          {() => (
            <Form>
              ...
              />
              <label>
                <Field className={classes.anonymous} type='checkbox' name='anonymous' />
              ...
              {isLoading ? (
                ...
                <Stack direction='row' spacing={2}>
                  ...
                  <Button variant='outlined' color='primary' component={Link} to='/feedback?tab=my'>
                    {t('button_cancel')}
                  </Button>
                </Stack>
              )}

...
import { Typography, Grid, Card, CardContent, Accordion, AccordionDetails, AccordionSummary } from '@mui/material';
...
const Information = () => {
  ...
  return (
    <Grid>
        <Card>
            <Typography color="primary" align="center" variant="h5">{('General information')}</Typography>
            <CardContent>  
                {topics.map((topic) => (

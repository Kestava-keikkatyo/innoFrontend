            ...
            return (
              <Form>
                <div>
                  <div>
                    <div>
                      <Typography color='success' className={classes.title} variant='h6'>
                        {t('feeling_report_question')}
                      </Typography>
                    </div>
                    <FormControl style={{ marginBottom: '20px' }}>
                      <RadioGroup row name='feeling'>
                        <Field
                          required
                          value={1}
                          icon={<SentimentVeryDissatisfiedIcon className={classes.icons} />}
                          checkedIcon={<SentimentVeryDissatisfiedIcon className={classes.icons} />}
                          as={Radio}
                        />
                        <Field
                          value={2}
                        ...
                        <Field
                          value={3}
                          icon={<SentimentSatisfiedAltIcon className={classes.icons} />}
                  ...
                  <div>
                    <div>
                      <Typography color='success' className={classes.title} variant='h6'>
                        {t('my_feeling_would_you_like_to_leave_a_comment')}
                      </Typography>
                    </div>

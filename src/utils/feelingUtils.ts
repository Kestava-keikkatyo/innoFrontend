...
const calculateColor = (value: number, maxValue: number) => {
  ...
  else if (index < 40) return colors[1]
  else if (index < 60) return colors[2]
  else if (index < 80) return colors[3]
  else if (index >= 80) return colors[4]
  else return 'white'
}
...
export const calculateCheer = (value: number, maxValue: number) => {
  const index = Math.round((value / maxValue) * 100)
  if (index < 20) return cheers[0]
  else if (index < 40) return cheers[1]
  else if (index < 60) return cheers[2]
  else if (index < 80) return cheers[3]
  else if (index >= 80) return cheers[4]
  else return 'oops! :('
}

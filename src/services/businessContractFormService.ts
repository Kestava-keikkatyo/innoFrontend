 ...
 */
const updateBusinessContractForm = async (
  businessContractFormId: any,
  businessContractForm: any,
) => {
  try {
    ...
    const res: any = await axios.put(
      `${baseUrl}/businesscontractforms/${businessContractFormId}`,
...
const deleteBusinessContractForm = async (businessContractFormId: any, userId: any) => {
  ...
  try {
    const res = await axios.delete(
      `${baseUrl}/businesscontractforms/${businessContractFormId}/${userId}`,
      authHeader(),
    )
    return res.data
  } catch (error) {
